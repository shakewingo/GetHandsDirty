# https://huggingface.co/deepseek-ai/deepseek-moe-16b-base/blob/main/tokenizer.json
...
#     tokenizer = DeepSeekV3Tokenizer("https://huggingface.co/deepseek-ai/deepseek-moe-16b-base/blob/main/")
#     tokenizer.get_vocab()