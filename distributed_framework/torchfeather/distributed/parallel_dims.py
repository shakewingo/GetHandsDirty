...
class ParallelDims:
    ...
    def build_mesh(self) -> DeviceMesh:
        ...
        ) # create a tenor which is kind of like torch.arange(0,  self.world_size)
        ...
        sparse_mesh = unflatten_mesh(
            ...
            # dp_shard * cp * tp / fsdp * fp = efsdp * ep * etp
        ...
        self._meshes = {
            "pp": dataloading_mesh["pp"], # take submesh of dataloading_mesh with dimension "pp"
    ...
    def get_mesh(self, dims: str | list[str]) -> DeviceMesh:
        # get sub mesh based on certain dim
