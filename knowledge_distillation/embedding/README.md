# Note
- This folder is copied from wyf3/llm_related repo with NO TEST
- Embedding training data is used a combo of query + pos + neg
- After lora fune-tuning, needs to merge the result with the base model and save.
# EMBEDDING蒸馏
## 蒸馏原理
